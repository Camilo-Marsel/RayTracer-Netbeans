...
//    int InicialR3;
  ...
  public Scene getUpdateScene(double v1x, double v1y, double v1z, double v1r, double v2x, double v2y, double v2z, double v2r, double v3x, double v3y, double v3z, double v3r, int vectorX, int vectorY, int vectorZ, int directionX, int directionY, int directionZ) {
    Vector<Sphere> orbs = new Vector<>();
